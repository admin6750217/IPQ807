主要编译阿里云ap8220,redmi-ax6,xiaomi-ax3000,xiaomi-ax9000全部带nss。
感谢:
...
编译的固件使用安装插件更换下面的源码:
https://mirrors.pku.edu.cn/immortalwrt/snapshots/targets/qualcommax/ipq807x/packages/packages.adb
